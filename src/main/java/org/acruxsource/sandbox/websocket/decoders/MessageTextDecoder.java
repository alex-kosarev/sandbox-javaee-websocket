    ...
    public boolean willDecode(String s) {
        if (s != null && !s.isEmpty()) {
            try (JsonReader messageReader = Json.createReader(new StringReader(s))) {
                ...
                if (LoginMessageEncoder.MESSAGE_CLASS_NAME.equals(className) || ChatMessageEncoder.MESSAGE_CLASS_NAME.equals(className) || PrivateChatMessageEncoder.MESSAGE_CLASS_NAME.equals(className)) {
                    return true;
                }
            }
        }
